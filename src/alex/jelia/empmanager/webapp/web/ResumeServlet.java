package alex.jelia.empmanager.webapp.web;
...
import alex.jelia.empmanager.webapp.util.DateUtil;
import alex.jelia.empmanager.webapp.util.HtmlHelper;
...
public class ResumeServlet extends HttpServlet {
            ...
            case "edit":
                ...
                for (SectionType type : SectionType.values()) {
                    ...
                    switch (type) {
                        ...
                        case EXPERIENCE:
                        case EDUCATION:
                            OrganizationsSection orgSection = (OrganizationsSection) section;
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        for (SectionType type : SectionType.values()) {
            ...
            if (HtmlHelper.isEmpty(value) && values.length < 2) {
                ...
                switch (type) {
                    ...
                    case EXPERIENCE:
                        ...
                        r.setSection(type, new OrganizationsSection(orgs));
                        break;
                }
            }
        }
